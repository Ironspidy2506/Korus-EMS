...
const EmployeeApproveRejectLeave: React.FC = () => {
    const { user } = useAuth();
    ...
    const fetchLeaves = async () => {
        try {
            setIsLoading(true);
            const response = await getLeaveForMyApprovals(user._id);
    ...
    const filteredLeaveRequests = useMemo(() => {
        return leaveRequests.filter((request: any) => {
            ...
            const matchesType = leaveTypeFilter === 'All' || (request.type && request.type.toLowerCase() === leaveTypeFilter.toLowerCase());
        ...
        return (
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Employees Leave Management</h1>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Select value={leaveTypeFilter} onValueChange={setLeaveTypeFilter}>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="lhd">Half Day Leave</SelectItem>
...
export default EmployeeApproveRejectLeave;
